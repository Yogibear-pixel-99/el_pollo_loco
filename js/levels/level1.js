...
level1 = new Level(
  ...
  [
    ...
    new BackgroundLayer("./img/5_background/layers/air.png", 719 * 5, 1),
    new BackgroundLayer("./img/5_background/layers/3_third_layer/1.png", 719 * 5, -2),
    new BackgroundLayer("./img/5_background/layers/2_second_layer/1.png", 719 * 5, -1),
