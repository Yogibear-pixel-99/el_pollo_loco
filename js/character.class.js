class Character extends MovableObject {
  ...
  resetIdle() {
    ...
    this.isIdle = false;
    this.animate();
    world.audiofiles.sfx.pepeIdle.pause();
    world.audiofiles.sfx.pepeLongIdle.pause();
    world.audiofiles.sfx.pepeIdle.currentTime = 0;
